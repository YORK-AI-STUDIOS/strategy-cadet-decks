/* =============================================================================
   Strategy Cadet, Nothing Technology, Run J Mk2 v3
...
// slideData
// =============================================================================
// One entry per slide, 88 total. The viewer's renderSlide() reads src and
...
const slideData = [
  ...
  { num: 48, src: 'slides/48-divider-marketing.html?chrome=off',           title: 'Part 07, Marketing plan' },
  ...
  { num: 55, src: 'slides/55-divider-social.html?chrome=off',              title: 'Part 08, Social deep' },
  ...
  { num: 61, src: 'slides/61-divider-appendix.html?chrome=off',            title: 'Part 09, Appendix frame' },
  ...
  { num: 67, src: 'slides/67-strategic-synthesis.html?chrome=off',         title: 'Strategic synthesis' },
  { num: 68, src: 'slides/68-founder-voice.html?chrome=off',               title: 'Founder voice analysis' },
  { num: 69, src: 'slides/69-india-global-expansion.html?chrome=off',      title: 'India and global expansion' },
  { num: 70, src: 'slides/70-cmf-brand-architecture.html?chrome=off',      title: 'CMF and brand architecture' },
  { num: 71, src: 'slides/71-cep-master-table.html?chrome=off',            title: 'CEP master table' },
  { num: 72, src: 'slides/72-news-pr-landscape.html?chrome=off',           title: 'News and PR landscape' },
  { num: 73, src: 'slides/73-brand-momentum.html?chrome=off',              title: 'Brand momentum' },
  { num: 74, src: 'slides/74-social-performance.html?chrome=off',          title: 'Social performance, extended' },
  { num: 75, src: 'slides/75-geo-scorecard.html?chrome=off',               title: 'Geo scorecard' },
  { num: 76, src: 'slides/76-share-of-search.html?chrome=off',             title: 'Share of search' },
  { num: 77, src: 'slides/77-reviews-trust-gap.html?chrome=off',           title: 'Reviews and trust gap' },
  { num: 78, src: 'slides/78-methodology.html?chrome=off',                 title: 'Methodology' },
  { num: 79, src: 'slides/79-about-strategy-cadet.html?chrome=off',        title: 'About Strategy Cadet' },
  { num: 80, src: 'slides/80-citations-1.html?chrome=off',                 title: 'Citations 1, refs 1-62' },
  { num: 81, src: 'slides/81-citations-2.html?chrome=off',                 title: 'Citations 2, refs 63-124' },
  { num: 82, src: 'slides/82-citations-3.html?chrome=off',                 title: 'Citations 3, refs 125-186' },
  { num: 83, src: 'slides/83-citations-4.html?chrome=off',                 title: 'Citations 4, refs 187-248' },
  { num: 84, src: 'slides/84-citations-5.html?chrome=off',                 title: 'Citations 5, refs 249-308' },
  { num: 85, src: 'slides/85-honest-limitations.html?chrome=off',          title: 'Honest limitations' },
  { num: 86, src: 'slides/86-brand-opportunities-summary.html?chrome=off', title: 'Brand opportunities summary' },
  { num: 87, src: 'slides/87-closing-divider.html?chrome=off',             title: 'Closing divider' },
  { num: 88, src: 'slides/88-back-cover.html?chrome=off',                  title: 'Back cover' },
];
...
// + citations + closing groups built in Run J Mk2 v3. Sub-items are the
...
const indexData = [
  ...
  { title: '11 - Extended analysis', subs: [
    { label: 'Strategic synthesis', slide: 67 },
    { label: 'Founder voice analysis', slide: 68 },
    { label: 'India and global expansion', slide: 69 },
    { label: 'CMF and brand architecture', slide: 70 },
    { label: 'CEP master table', slide: 71 },
    { label: 'News and PR landscape', slide: 72 },
    { label: 'Brand momentum', slide: 73 },
    { label: 'Social performance, extended', slide: 74 },
    { label: 'Geo scorecard', slide: 75 },
    { label: 'Share of search', slide: 76 },
    { label: 'Reviews and trust gap', slide: 77 },
  ]},
  { title: '12 - Method and citations', subs: [
    { label: 'Methodology', slide: 78 },
    { label: 'About Strategy Cadet', slide: 79 },
    { label: 'Citations, refs 1-62', slide: 80 },
    { label: 'Citations, refs 63-124', slide: 81 },
    { label: 'Citations, refs 125-186', slide: 82 },
    { label: 'Citations, refs 187-248', slide: 83 },
    { label: 'Citations, refs 249-308', slide: 84 },
  ]},
  { title: '13 - Closing', subs: [
    { label: 'Honest limitations', slide: 85 },
    { label: 'Brand opportunities summary', slide: 86 },
    { label: 'Closing divider', slide: 87 },
    { label: 'Back cover', slide: 88 },
  ]},
];
